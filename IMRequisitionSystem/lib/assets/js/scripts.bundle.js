...
KTUtil.ready(function() {
    ...
    if (typeof KTLayoutHeaderMenu !== 'undefined') {
        ...
        KTLayoutHeaderMenu.init('FEMSMenu', 'kt_header_menu_wrapper');
        KTLayoutHeaderMenu.init('IRISMenu', 'kt_header_menu_wrapper');
        KTLayoutHeaderMenu.init('TankTestingMenu', 'kt_header_menu_wrapper');
        KTLayoutHeaderMenu.init('ATRMenu', 'kt_header_menu_wrapper');
        KTLayoutHeaderMenu.init('PGDMSMenu', 'kt_header_menu_wrapper');
        KTLayoutHeaderMenu.init('EPermitMenu', 'kt_header_menu_wrapper');
        KTLayoutHeaderMenu.init('PPEMenu', 'kt_header_menu_wrapper');
        KTLayoutHeaderMenu.init('SafetyTrainingMenu', 'kt_header_menu_wrapper');
        KTLayoutHeaderMenu.init('FirstAiderMenu', 'kt_header_menu_wrapper');
        KTLayoutHeaderMenu.init('LogsheetMenu', 'kt_header_menu_wrapper');
        KTLayoutHeaderMenu.init('FEMS_Menu', 'kt_header_menu_wrapper');
        KTLayoutHeaderMenu.init('SprinklerMenu', 'kt_header_menu_wrapper');
        KTLayoutHeaderMenu.init('SafetyKitMenu', 'kt_header_menu_wrapper');
        KTLayoutHeaderMenu.init('OHCMenu', 'kt_header_menu_wrapper');
        KTLayoutHeaderMenu.init('BBSMenu', 'kt_header_menu_wrapper');
    }
    ...
    if (typeof KTLayoutSubheader !== 'undefined') {
        ...
        KTLayoutSubheader.init('PGDMSMaster', 'kt_subheader');
        KTLayoutSubheader.init('PGDMSCoordinator', 'kt_subheader');
        KTLayoutSubheader.init('PGDMSUser', 'kt_subheader');
        KTLayoutSubheader.init('EpermitMaster', 'kt_subheader');
        KTLayoutSubheader.init('EpermitUserRegistration', 'kt_subheader');
        KTLayoutSubheader.init('EPermitRequest', 'kt_subheader');
        KTLayoutSubheader.init('EPermitIssue', 'kt_subheader');
        KTLayoutSubheader.init('EPermitApproval', 'kt_subheader');
        KTLayoutSubheader.init('EPermitSIC', 'kt_subheader');
        KTLayoutSubheader.init('EPermitTA', 'kt_subheader');
        KTLayoutSubheader.init('STMaster', 'kt_subheader');
        KTLayoutSubheader.init('STMasterCoordinator', 'kt_subheader');
        KTLayoutSubheader.init('STDipartmentCoordinator', 'kt_subheader');
        KTLayoutSubheader.init('FirstAiderMaster', 'kt_subheader');
        KTLayoutSubheader.init('FirstAiderCoordinator', 'kt_subheader');
        KTLayoutSubheader.init('FirstAiderNominator', 'kt_subheader');
        KTLayoutSubheader.init('SPDVTypeRegistration', 'kt_subheader'); 
        KTLayoutSubheader.init('SPDVProductRegistration', 'kt_subheader');
        KTLayoutSubheader.init('SafetyKitTypeRegistration', 'kt_subheader');
        KTLayoutSubheader.init('SafetyKitProductRegistration', 'kt_subheader');
        KTLayoutSubheader.init('FAMasterCoordinator', 'kt_subheader');
        KTLayoutSubheader.init('FADepartmentCoordinator', 'kt_subheader');
        KTLayoutSubheader.init('FAEmployee', 'kt_subheader');
        KTLayoutSubheader.init('ElogBookSICMaster', 'kt_subheader');
        KTLayoutSubheader.init('OHCMasterCoordinator', 'kt_subheader');
        KTLayoutSubheader.init('OHCMaintenance', 'kt_subheader');
        KTLayoutSubheader.init('OHCUser', 'kt_subheader');
        KTLayoutSubheader.init('CreateObservation', 'kt_subheader');
    }
    ...
    if (typeof KTLayoutStretchedCard !== 'undefined') {
        ...
        KTLayoutStretchedCard.init('kt_page_stretched_card2');
    }
